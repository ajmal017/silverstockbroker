...
class CommentariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commentary" do
    assert_difference('Commentary.count') do
      post commentaries_url, params: { commentary: { body: @commentary.body, title: @commentary.title } }
    end
  ...
  test "should update commentary" do
    patch commentary_url(@commentary), params: { commentary: { body: @commentary.body, title: @commentary.title } }
